...
First things first. A **Scrum Team** is a group of individuals working together to deliver the products and solutions in an Agile environment using the Scrum framework. The team is typically composed of three key roles (later explained): Product Owner, Scrum Master, Development Team (=is cross-functional).
